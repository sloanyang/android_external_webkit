...
//this file copy from external/chromium/net/base/Mime_sniffer.h

#ifndef MIME_SNIFFER_ANDROID_H__
#define MIME_SNIFFER_ANDROID_H__
#pragma once
...
#endif  // MIME_SNIFFER_ANDROID_H__
